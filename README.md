...
| 單據 | 顯示欄位 |
|------|---------|
| 1. 整經盤頭生產 | 生產人員（整經）、紗種、整經條數、盤頭號碼、重量、長度、批號 |
| 2. 盤頭領料上機 | 生產人員（織帶）、紗種、整經條數、盤頭號碼、重量、機台號碼 |
| 3. 機上盤頭退料 | 生產人員（織帶）、紗種、盤頭號碼、重量、刻度 |
...
`時間戳記 / 課別 / 單據別 / 生產人員 / 紗種 / 整經條數 / 盤頭號碼 / 重量KG / 長度M / 批號 / 機台號碼 / 刻度cm`
